...
<div class="row">
    <div class="col-lg-8">
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                <h2 class="fw-bold">{{ $video->titre }}</h2>
                <p class="text-muted">⏱️ Durée : {{ gmdate("H:i:s", $video->duree) }}</p>
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-header bg-success text-white fw-bold">
                💬 Commentaires ({{ $video->commentaires->count() }})
            </div>
            <div class="card-body">
                @foreach($video->commentaires as $commentaire)
    ...
    <div class="col-lg-4">
        ...
        <a href="/videos" class="btn btn-outline-success w-100">← Retour aux vidéos</a>
    </div>
</div>
@endsection